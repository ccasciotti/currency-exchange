...
class UriAbstractTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $stub1 = $this->getMockForAbstractClass('\CurrencyExchange\Uri\UriAbstract', [HttpClient::HTTP_GET]);
        $stub2 = $this->getMockForAbstractClass('\CurrencyExchange\Uri\UriAbstract', [HttpClient::HTTP_POST]);
